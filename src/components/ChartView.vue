...
export default {
  ...
  methods: {
    ...
    createChart() {
      ...
      const backgroundColor = this.chartMode === 'dark' ? 'rgb(255, 0, 255, 0.1)' : 'light background color';
      ...
      const plugin = {
        ...
        beforeDraw: (chart, args, options) => {
          ...
          ctx.fillStyle = options.color || (this.chartMode === 'dark' ? '#99ffff' : 'light background color');
